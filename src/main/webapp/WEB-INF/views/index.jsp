...
<body>
	...
	<main>
		<div class="categories">
			<div class="category-btn" onclick="toggleDropdown('dropdown1')">
				...
				<div id="dropdown1" class="dropdown-content">
					<a href="#">내이력서관리</a> <a href="<c:url value='/resumes/new'/>">새이력서작성</a>
					<a href="#">이력서작성가이드</a> <a href="#">인적성 면접 후기</a> <a href="#">인성역량검사</a>
					<a href="#">역량테스트(MICT)</a> <a href="#">공기업모의고사</a> <a href="#">취업TOOL</a>
				</div>
			</div>
			<div class="category-btn" onclick="toggleDropdown('dropdown2')">
				<h2>기업/채용</h2>
				<div id="dropdown2" class="dropdown-content">
					<a href="<c:url value='/jobPost/list'/>">TOP100</a> <a href="#">1000대기업공채</a>
					<a href="#">공공기관채용일정</a> <a href="#">전문채용관</a> <a href="#">슈퍼채용관</a>
				</div>
			</div>
			<div class="category-btn" onclick="toggleDropdown('dropdown3')">
				<h2>개인정보관리</h2>
				<div id="dropdown3" class="dropdown-content">
					<a href="#">개인정보수정</a> <a href="#">입사지원현황</a> <a href="#">포지션제안</a>
		...
		<div class="job-section">
			...
			<div class="job-listings">
				...
				<div class="job-card">
					<a
						href="https://career.nexon.com/user/recruit/member/postDetail?joinCorp=NX&reNo=20220145">
				...
				<div class="job-card">
					<a href="https://recruit.passorder.co.kr/careers"> <img
						src="/resources/image/패스오더.jpg" alt="Company 2 Logo">
						<div class="job-info">
				...
				<div class="job-card">
					<a href="https://www.socarcorp.kr/careers/jobs"> <img
						src="/resources/image/socar.jpg" alt="Company 2 Logo">
						<div class="job-info">
				...
				<div class="job-card">
					<a href=""> <img src="/resources/image/profile.jpg"
						alt="Company 2 Logo">
						<div class="job-info">
							<h3>추가 공고</h3>
							<p>뚱이</p>
	...
	<footer>
		...
		<div class="footer-details">
			...
			<h5>사업자등록 : 222-33-6666, 직업정보제공사업 : 서울 관악 제 800-9호, 통신판매업 : 제
				6006-98564호</h5>
				...
				.addEventListener(
						...
						function() {
							var searchQuery = document
									.getElementById('searchInput').value.trim(); // 입력된 검색어 가져오기 (공백 제거)

							// 검색어가 비어 있지 않은 경우에만 처리
							if (searchQuery !== '') {
								// 검색 결과 페이지 URL 생성
								var searchUrl = '/jobpost/list?query='
