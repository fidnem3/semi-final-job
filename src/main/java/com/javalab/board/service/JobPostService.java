...
public interface JobPostService {
	/*
	 * public VS void 명식적과 암시적 차이
	 * 
	 * void insertJobPost(JobPostVo jobPost);
	 * 
	 * 접근 제어자를 명시하지 않았지만 암시적으로 public입니다.
	 * 
	 * public void insertJobPost(JobPostVo jobPost);
	 * 
	 * 접근 제어자를 명시적으로 선언했습니다.
	 */
