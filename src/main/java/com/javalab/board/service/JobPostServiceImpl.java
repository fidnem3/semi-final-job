...
/**
 * JobPostServiceImpl 클래스
 * 채용 공고 관련 비즈니스 로직을 처리하는 서비스 구현 클래스입니다.
 * JobPostService 인터페이스를 구현하며, 실제 데이터 처리는 JobPostMapper를 통해 수행합니다.
 */
@Service
@Slf4j
public class JobPostServiceImpl implements JobPostService {
     ...
     */
    @Override
    public int insertJobPost(JobPostVo jobPost) {
